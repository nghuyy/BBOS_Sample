...
public final class SendNonBlockRssScreen extends MainScreen
{
    ...
    public SendNonBlockRssScreen(final CommunicationController controller)
    {
        ...
        _uriSenderField = new EditField("URI:", CommunicationController.ECHO_SERVER_URI + "RSS", 140, 0);
    ...
    private static final class SendNonBlockRssScreenCallback extends ResponseCallback
    {

        private SendNonBlockRssScreen _screen;


        private SendNonBlockRssScreenCallback(SendNonBlockRssScreen screen)
        {
            _screen = screen;
        }
