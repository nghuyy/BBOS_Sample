...
public final class MessageListDemoDaemon extends Application implements ApplicationMessageFolderListener
{
    ...
    void init()
    {
        ...
        ApplicationIcon newIcon = new ApplicationIcon(EncodedImage.getEncodedImageResource("res/img/new.png"));
        ApplicationIcon readIcon = new ApplicationIcon(EncodedImage.getEncodedImageResource("res/img/read.png"));
        ApplicationIcon repliedIcon = new ApplicationIcon(EncodedImage.getEncodedImageResource("res/img/replied.png"));
        ApplicationIcon deletedIcon = new ApplicationIcon(EncodedImage.getEncodedImageResource("res/img/deleted.png"));
    ...
    private static class ReplyContextMenu extends ApplicationMenuItem
    {
         ...
         */
        public ReplyContextMenu(int order)
        {
            super(order);

            // Set icon for GCM menu
            EncodedImage eiReply = EncodedImage.getEncodedImageResource("res/img/sm_reply.png");
            if(eiReply != null)
            {
                Image image = ImageFactory.createImage(eiReply);
                this.setIcon(image);
            }
        }
        ...
        public Object run(Object context)
        {
            if(context instanceof DemoMessage)
            {
                ...
                ApplicationMessageFolderRegistry reg = ApplicationMessageFolderRegistry.getInstance();
                ApplicationMessageFolder folder = reg.getApplicationFolder(MessageListDemo.INBOX_FOLDER_ID);
    ...
    private static class MarkOpenedContextMenu extends ApplicationMenuItem
    {
        ...
        MarkOpenedContextMenu(int order)
        {
            ...
            // Set icon for GCM menu
            EncodedImage eiMarkOpened = EncodedImage.getEncodedImageResource("res/img/sm_mark_opened.png");
    ...
    private static class MarkUnreadContextMenu extends ApplicationMenuItem
    {
        ...
        MarkUnreadContextMenu(int order)
        {
            ...
            // Set icon for GCM menu
            EncodedImage eiMarkUnOpened = EncodedImage.getEncodedImageResource("res/img/sm_mark_unopened.png");
    ...
    static class OpenContextMenu extends ApplicationMenuItem
    {
        ...
        public OpenContextMenu(int order)
        {
            ...
            // Set icon for GCM menu
            EncodedImage eiOpen = EncodedImage.getEncodedImageResource("res/img/sm_open.png");
            if(eiOpen != null)
            {
    ...
    public void actionPerformed(int action, ApplicationMessage[] messages, ApplicationMessageFolder folder)
    {
        ...
        synchronized(messageStore)
        {
            ...
            else
            {
                ...
                if(action == ApplicationMessageFolderListener.MESSAGE_DELETED && folder.getId() == MessageListDemo.INBOX_FOLDER_ID)
                {
