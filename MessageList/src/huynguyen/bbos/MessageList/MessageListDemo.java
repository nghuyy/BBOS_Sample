...
public final class MessageListDemo extends UiApplication
{
    ...
    public static void main(String[] args)
    {
        if(args != null && args.length > 0)
        {
            ...
            if(args.length == 1 && args[0].equals("startup"))
            {
                ...
                EncodedImage indicatorIcon = EncodedImage.getEncodedImageResource("res/img/indicator.png");
            ...
            else if(args.length == 1 && args[0].equals("gui"))
            {
                ...
                MessageListDemo messageScreenApp = new MessageListDemo(false);
        ...
        else
        {
            ...
            MessageListDemo mainGuiApp = new MessageListDemo(true);
     ...
     */
    public MessageListDemo(boolean isMainGui)
    {
        if(isMainGui)
        {
            MainScreen mainScreen = new MainScreen();
            mainScreen.setTitle("Message List Demo");
            mainScreen.add(new RichTextField("Please choose one of the menu options, then open the Messages application from the home " 
    ...
    {        
        MenuItemWithIcon appendUnreadMessage = new MenuItemWithIcon("Append Unread Message", 0, "res/img/sm_add_message.png");
        ...
        MenuItemWithIcon appendOpenedMessage = new MenuItemWithIcon("Append Opened Message", 1, "res/img/sm_add_message.png");
